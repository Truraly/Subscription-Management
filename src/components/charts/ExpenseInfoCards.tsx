        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">每日平均</span>
            </div>
    ...
    <div className={`space-y-6 ${className}`}>
        ...
        {monthlyData.length > 0 ? (
          ...
          <Card>
            <CardContent className="flex items-center justify-center h-32">
              <p className="text-muted-foreground">无可用月度数据</p>
            </CardContent>
          </Card>
        )}
      </div>
      ...
      <div>
        ...
        {quarterlyData.length > 0 ? (
          ...
          <Card>
            <CardContent className="flex items-center justify-center h-32">
              <p className="text-muted-foreground">无可用季度数据</p>
            </CardContent>
          </Card>
        )}
      </div>
      ...
      <div>
        ...
        {yearlyData.length > 0 ? (
          ...
          <Card>
            <CardContent className="flex items-center justify-center h-32">
              <p className="text-muted-foreground">无可用年度数据</p>
            </CardContent>
          </Card>
        )}
      </div>
